...
public class TchInfoMethod {
    ...
    public static void cancel() {
        mainSystem.tchInfoView.dispose();
    }
    ...
    private static Teacher checkInput() {
        //获取输入框内容
        String number = mainSystem.tchInfoView.getField_number();
        String name = mainSystem.tchInfoView.getField_name();
        String age = mainSystem.tchInfoView.getField_age();
        String sex = mainSystem.tchInfoView.getField_sex();
        String college = mainSystem.tchInfoView.getField_college();
        String profession = mainSystem.tchInfoView.getField_profession();
        String job = mainSystem.tchInfoView.getField_job();
        String politicalStatus = mainSystem.tchInfoView.getField_politicalStatus();
        String hometown = mainSystem.tchInfoView.getField_hometown();
        String nationality = mainSystem.tchInfoView.getField_nationality();
        String id = mainSystem.tchInfoView.getField_id();
        String phone = mainSystem.tchInfoView.getField_phone();
        String address = mainSystem.tchInfoView.getField_address();

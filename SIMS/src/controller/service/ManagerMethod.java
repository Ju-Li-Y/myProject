...
import view.CourseInfoView;
import view.LoginView;
import view.StuInfoView;
import view.TchInfoView;
...
public class ManagerMethod {
    ...
    private static void loadTime() {
        ...
        mainSystem.mgrMainView.setLabel_time(time);
    }
    ...
    public static void logout() {
        ...
        if (result == JOptionPane.YES_OPTION) {
            mainSystem.mgrMainView.dispose();
    ...
    public static void showAllStudent() {
        ...
        mainSystem.mgrMainView.setStuCbBox(collegeModel, majorModel, statusModel);
    }

    /** 显示符合要求的学生信息 */
    public static void searchStudent() {
        //获取输入框、下拉框内容
        String number = mainSystem.mgrMainView.getField_stuNumber();
        String name = mainSystem.mgrMainView.getField_stuName();
        String college = mainSystem.mgrMainView.getCbBox_stuCollege();
        String major = mainSystem.mgrMainView.getCbBox_stuMajor();
        String status = mainSystem.mgrMainView.getCbBox_stuStatus();
    ...
    private static void setStuInfoModel(List<Student> list) {
        ...
        mainSystem.mgrMainView.setTable_stuInfo(new tableModel());
    }

    /** 修改选中的学生信息 */
    public static void changeStudentInfo() {
        //获取选中的学生学号
        String number = mainSystem.mgrMainView.getSelectedStuNumber();
        //查询对应学生信息
        List<Student> list = new StudentDAOImpl()
        ...
        if (mainSystem.stuInfoView == null) {
            mainSystem.stuInfoView = new StuInfoView(1);
        }
        mainSystem.stuInfoView.setField(student);
    }
    ...
    public static void addNewStudent() {
        //判断是否打开了新界面，避免同时打开多个界面
        if (mainSystem.stuInfoView == null) {
            mainSystem.stuInfoView = new StuInfoView();
        }
        mainSystem.stuInfoView.clearField();
    }
    ...
    public static void showAllTeacher() {
        ...
        DefaultComboBoxModel<String> statusModel = new DefaultComboBoxModel<>(statusData);
        mainSystem.mgrMainView.setTchCbBox(collegeModel, jobModel, statusModel);
    }

    /** 显示符合要求的教师信息 */
    public static void searchTeacher() {
        //获取输入框、下拉框内容
        String number = mainSystem.mgrMainView.getField_tchNumber();
        String name = mainSystem.mgrMainView.getField_tchName();
        String college = mainSystem.mgrMainView.getCbBox_tchCollege();
        String job = mainSystem.mgrMainView.getCbBox_tchJob();
        String status = mainSystem.mgrMainView.getCbBox_tchStatus();
    ...
    private static void setTchInfoModel(List<Teacher> list) {
        ...
        mainSystem.mgrMainView.setTable_tchInfo(new tableModel());
    }

    /** 修改选中的教师信息 */
    public static void changeTeacherInfo() {
        //获取选中的教师工号
        String number = mainSystem.mgrMainView.getSelectedTchNumber();
        //查询对应教师信息
        List<Teacher> list = new TeacherDAOImpl()
        ...
        //判断是否打开了新界面，避免同时打开多个界面
        if (mainSystem.tchInfoView == null)
            mainSystem.tchInfoView = new TchInfoView(1);
        mainSystem.tchInfoView.setField(teacher);
    }
    ...
    public static void addNewTeacher() {
        //判断是否打开了新界面，避免同时打开多个界面
        if (mainSystem.tchInfoView == null)
            mainSystem.tchInfoView = new TchInfoView();
        mainSystem.tchInfoView.clearField();
    }
    ...
    public static void showAllCourse() {
        ...
        mainSystem.mgrMainView.setCourseCbBox(collegeModel, typeModel);
    }

    /** 显示符合要求的课程信息 */
    public static void searchCourse() {
        //获取输入框、下拉框内容
        String college = mainSystem.mgrMainView.getCbBox_courseCollege();
        String type = mainSystem.mgrMainView.getCbBox_courseType();
    ...
    private static void setCourseInfoModel(List<Course> list) {
        ...
        mainSystem.mgrMainView.setTable_courseInfo(new tableModel());
    }

    /** 修改选中的课程信息 */
    public static void changeCourseInfo() {
        //获取选中的课程编号
        String number = mainSystem.mgrMainView.getSelectedCourseNumber();
        //查询对应教师信息
        List<Course> list = new CourseDAOImpl().queryCourseInfo(number, "", "");
        Course course = list.get(0);

        //判断是否打开了新界面，避免同时打开多个界面
        if (mainSystem.courseInfoView == null)
            mainSystem.courseInfoView = new CourseInfoView(1);
        mainSystem.courseInfoView.setField(course);
    }
    ...
    public static void addNewCourse() {
        //判断是否打开了新界面，避免同时打开多个界面
        if (mainSystem.courseInfoView == null)
            mainSystem.courseInfoView = new CourseInfoView();
        mainSystem.courseInfoView.clearField();
    }

...
public class StuInfoMethod {
    ...
    public static void cancel() {
        mainSystem.stuInfoView.dispose();
    }
    ...
    private static Student checkInput() throws ParseException {
        ...
        //获取输入框内容
        String number = mainSystem.stuInfoView.getField_number();
        String name = mainSystem.stuInfoView.getField_name();
        String age = mainSystem.stuInfoView.getField_age();
        String sex = mainSystem.stuInfoView.getField_sex();
        String college = mainSystem.stuInfoView.getField_college();
        String preMajor = mainSystem.stuInfoView.getField_preMajor();
        String major = mainSystem.stuInfoView.getField_major();
        String stuClass = mainSystem.stuInfoView.getField_class();
        String politicalStatus = mainSystem.stuInfoView.getField_politicalStatus();
        String startTime = mainSystem.stuInfoView.getField_startTime();
        String hometown = mainSystem.stuInfoView.getField_hometown();
        String nationality = mainSystem.stuInfoView.getField_nationality();
        String id = mainSystem.stuInfoView.getField_id();
        String phone = mainSystem.stuInfoView.getField_phone();
        String address = mainSystem.stuInfoView.getField_address();
        String isSports = mainSystem.stuInfoView.getField_isSports();
        String selectCourse = mainSystem.stuInfoView.getField_selectCourse();

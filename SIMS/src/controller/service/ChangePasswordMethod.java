...
public class ChangePasswordMethod {
    ...
    public static void changePassword() {
        //从输入框读取内容
        String oldPassword = mainSystem.changePasswordView.getOldPassword();
        String newPassword = mainSystem.changePasswordView.getNewPassword();
        String confirmPassword = mainSystem.changePasswordView.getConfirmPassword();
        //判断输入是否符合要求
        //任意输入框为空
            ...
            if (user != null) {
                ...
                if (newPassword.equals(confirmPassword)) {
                    ...
                    if (new AccountDAOImpl().updatePassword(LoginView.user.getNumber(), newPassword)) {
                        ...
                        mainSystem.changePasswordView.dispose();
                    }
                    //密码修改失败
                    else {

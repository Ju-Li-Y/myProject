...
public class CourseInfoMethod {
    ...
    public static void cancel() {
        mainSystem.courseInfoView.dispose();
    }
    ...
    private static Course checkInput() {
        //获取输入框内容
        String number = mainSystem.courseInfoView.getField_number();
        String name = mainSystem.courseInfoView.getField_name();
        String teacher = mainSystem.courseInfoView.getField_teacher();
        String college = mainSystem.courseInfoView.getField_college();
        String profession = mainSystem.courseInfoView.getField_profession();
        String type = mainSystem.courseInfoView.getField_type();
        String credit = mainSystem.courseInfoView.getField_credit();
        String period = mainSystem.courseInfoView.getField_period();

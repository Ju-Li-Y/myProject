...
public class TeacherMethod {
    ...
    public static void logout() {
        ...
        if (result == JOptionPane.YES_OPTION) {
            mainSystem.tchMainView.dispose();
    ...
    public static void showAllCourse() {
        ...
        mainSystem.tchMainView.setCbBox_type(typeModel);
        mainSystem.tchMainView.setCbBox_course(courseModel);
    }

    /** 显示对应类型的课程 */
    public static void searchCourse() {
        //获取选择的课程性质
        String type = mainSystem.tchMainView.getCbBox_type();
    ...
    private static void setCourseModel(List<Course> list) {
        ...
        mainSystem.tchMainView.setTable_course(model);
    }
    ...
    public static void showStuScore() {
        //获取选中的课程名
        String courseName = mainSystem.tchMainView.getCbBox_course();
    ...
    private static void setScoreModel(List<Student> list) {
        ...
        mainSystem.tchMainView.setTable_score(new tableModel());
    }

    /** 编辑选中学生的成绩 */
    public static void editScore() {
        //获取要编辑的学生学号和成绩
        String[] stuInfo = mainSystem.tchMainView.getSelectedStuInfo();
    ...
    public static void loadPersonalInfoPage() {
        ...
        Teacher teacher = list.get(0);
        //显示个人信息
        mainSystem.tchMainView.setLabel_name(teacher.getName());
        mainSystem.tchMainView.setLabel_number(teacher.getNumber());
        mainSystem.tchMainView.setLabel_sex(teacher.getSex());
        mainSystem.tchMainView.setLabel_age(teacher.getAge());
        mainSystem.tchMainView.setLabel_nationality(teacher.getNationality());
        mainSystem.tchMainView.setLabel_politicalStatus(teacher.getPoliticalStatus());
        mainSystem.tchMainView.setLabel_hometown(teacher.getHometown());
        mainSystem.tchMainView.setLabel_id(teacher.getId());
        mainSystem.tchMainView.setLabel_address(teacher.getAddress());
        mainSystem.tchMainView.setLabel_phone(teacher.getPhone());
        mainSystem.tchMainView.setLabel_college(teacher.getCollege());
        mainSystem.tchMainView.setLabel_profession(teacher.getProfession());
        mainSystem.tchMainView.setLabel_job(teacher.getJob());
    }
    ...
    public static void editAddress() {
        //存储之前的地址
        preAddress = mainSystem.tchMainView.getLabel_address();
        mainSystem.tchMainView.changeAddressCard();
        mainSystem.tchMainView.changeBtn_editAddress();
    }

    /** 更新地址信息 */
    public static void updateAddress() {
        String address = mainSystem.tchMainView.getField_address();
        //判断用户输入是否符合要求
        //输入为空
        if (address.equals("")) {
        ...
        //进行数据更新
            ...
            if (new TeacherDAOImpl().updateAddress(LoginView.user.getNumber(), address, null)) {
                JOptionPane.showMessageDialog(null, "地址更改成功！",
                                              "提示", JOptionPane.INFORMATION_MESSAGE);
                mainSystem.tchMainView.setLabel_address(address);
            } else {
    ...
    public static void editPhone() {
        //存储之前的地址
        prePhone = mainSystem.tchMainView.getLabel_phone();
        mainSystem.tchMainView.changePhoneCard();
        mainSystem.tchMainView.changeBtn_editPhone();
    }

    /** 更新电话信息 */
    public static void updatePhone() {
        String phone = mainSystem.tchMainView.getField_phone();
        //判断用户输入是否符合要求
        //输入为空
        if (phone.equals("")) {
        ...
        //进行数据更新
            ...
            if (new TeacherDAOImpl().updateAddress(LoginView.user.getNumber(), null, phone)) {
                JOptionPane.showMessageDialog(null, "号码更改成功！",
                                              "提示", JOptionPane.INFORMATION_MESSAGE);
                mainSystem.tchMainView.setLabel_phone(phone);
            } else {
